...
public class CompanyServiceImpl implements CompanyService {
    ...
    public Long createCompany() {
        return companyRdbService.createCompany();
    }
    ...
    public Integer updateCompany(CompanyBo companyBo) {
        ...
        return companyRdbService.updateCompany(company);
    }

    @Override
    public CompanyBo findCompanyByCompanyId(Long companyId) {
        Company company = companyRdbService.findCompanyByCompanyId(companyId);
    ...
    public Pager<CompanyBo> findAllCompanyPager(Integer firstResult, Integer sizeNo) {
        Pager<Company> companyPager = companyRdbService.findAllCompanyPager(new Integer[]{CompanyStatus.Active.getCode(), CompanyStatus.Pause.getCode()}, firstResult, sizeNo);
    ...
    public Integer updateCompanyBizlicense(Long companyId, Long fileId) {
        return companyRdbService.updateCompanyBizlicense(companyId, fileId);
    }

    @Override
    public Integer updateCompanyLogo(Long companyId, Long fileId) {
        return companyRdbService.updateCompanyLogo(companyId, fileId);
    }

    @Override
    public Integer updateCompanyUserIdCard(Long companyId, Long fileId) {
        return companyRdbService.updateCompanyUserIdCard(companyId, fileId);
    }

    @Override
    public Integer updateCompanyFacade(Long companyId, Long fileId) {
        return companyRdbService.updateCompanyFacade(companyId, fileId);
    }
}
