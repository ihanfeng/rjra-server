...
public class SaveUser extends AbstractExecuter {
    ...
    static String sql = "insert into account_user(user_mobile, user_pwd, user_status, user_create_time, user_update_time) values (?,?,?,?,?)";
    ...
    public Object execute(Object[] params) {
        ...
        PstAssign pst = new PstAssign() {
            ...
            public void setParam(PreparedStatement ps) throws SQLException {
                ...
                ps.setObject(2, pwd);
                ps.setObject(3, UserStatus.Active.getCode());
