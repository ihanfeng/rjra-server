 ...
 */
public class BatchSaveWork extends AbstractExecuter {
    ...
    public Object execute(Object[] params) {
        final List<Work> workList = (List<Work>) params[0];

        return batchSaveResultId(sql, new BatchPstAssign<Work>() {
            @Override
            public void setParam(PreparedStatement ps, Work work) throws SQLException {
