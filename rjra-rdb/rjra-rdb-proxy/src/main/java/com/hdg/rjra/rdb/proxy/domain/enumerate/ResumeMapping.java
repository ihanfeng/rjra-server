...
public enum ResumeMapping implements BaseMapping {
    ...
    ResumeHomeAreaId("resume_home_area_id"),
    ResumeHomeCityId("resume_home_city_id"),
    ResumeHomeProvinceId("resume_home_province_id"),
    ResumeHomeAddress("resume_home_address", " like "),
